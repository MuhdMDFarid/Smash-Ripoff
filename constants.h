...
const UCHAR A_KEY = 0x41;		// A key
const UCHAR B_KEY = 0x42;		// B key
const UCHAR C_KEY = 0x43;		// C key
const UCHAR D_KEY = 0x44;		// D key
...
const UCHAR R_KEY = 0x52;		// R key
const UCHAR S_KEY = 0x53;		// S key
const UCHAR T_KEY = 0x54;		// T key
const UCHAR U_KEY = 0x55;		// U key
const UCHAR V_KEY = 0x56;		// V key
const UCHAR W_KEY = 0x57;		// W key
